...
import { BsFillChatSquareDotsFill, BsFillChatSquareFill, BsFillPinAngleFill } from 'react-icons/bs';
...
const ChatSection = () => {
  return (
     ...
     <span className='mt-3 ml-3' style={{color:"white",fontSize:"30px"}} ><Link to="/admin/home"
     style={{color:"white",fontSize:"30px"}}><IoMdArrowRoundBack/>
     </Link></span>
    <h2 className='text-white text-center mt-4 ml-4' style={{fontStyle:"Roboto",fontWeight:"600"}} >
    Chats</h2>
    </div>
