 ...
 if(props?.open===true){
  ...
  return (
   <div className='content'>
            <div>
                <AiOutlineDollar onClick={toggleModal} className='ml-2' style={{color:"white",fontSize:"35px",marginTop:"-110px",marginRight:"130px",cursor:"pointer",background:"#1e1e26",borderRadius:"0 20px 0 0",paddingTop:"10px"}}/>
