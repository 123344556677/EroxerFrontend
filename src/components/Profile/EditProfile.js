 ...
 const updation=async()=>{
  ...
  return (
    <div className='content' style={{zoom:"0.80"}}>
     <span className='' style={{color:"white",fontSize:"10px",marginLeft:"50px"}} ><Link to="/admin/profile"
    ...
    <Media className='mt-4 ml-3 chat-media'>
      <Media left>
        <img object  src={userData?.profilePic?userData?.profilePic:profilSeven} alt="jannan" className="upper-profile rounded-circle" />
      </Media>
    ...
    <Col sm={10}>
      ...
      />
      <p className=''style={{color:"#BFB8B8",fontSize:"10px"}}>
    In most cases, 
    you will be able to change your username back to umair_rafiii for another 14 days.
    </p>
    </Col>
    </FormGroup>
                <FormGroup row className='mt-3'>
    ...
    <Col sm={8} xl={9}>
      ...
      />
      <p className=''style={{color:"#BFB8B8",fontSize:"10px",marginLeft:"-10%"}}>
    Editing your links is only available onmobile. Visit the Erroxer app and edit your profile 
    ...
    <Input
     ...
     />
     <h5 className='mb-0 mt-3' style={{color:"#BFB8B8",fontWeight:"600"}}>
    Personal Information </h5>
    <p className=''style={{color:"#BFB8B8",fontSize:"10px"}}>
    Provide your personal information, even if the account 
    is used for a business, a pet or something else. This wont be a part of your public profile.
    </p>
     </Col>
    </FormGroup>
    ...
    <Col sm={8} xl={9}>
     ...
     <h1 className='text-center' style={{marginLeft:"20%"}}><Button className="reset-button" onClick={updation}>Submit</Button></h1>
   </Col>
     </Row>
     </Col>
    <Col xl={4}>
